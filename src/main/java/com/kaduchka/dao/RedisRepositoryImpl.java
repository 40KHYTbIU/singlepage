...
public class RedisRepositoryImpl implements RecordRepository {
  ...
  public static final String SCRIPT_TEXT = "local charSet = redis.call('ZRANGEBYSCORE', KEYS[1], ARGV[1], ARGV[2]); " +
    "redis.call('del', KEYS[2]); " +
    "for k,v in pairs(charSet) do redis.call('zadd', KEYS[2], 0, v) end;";
  public static final String IDS = "ids";
  public static final String NUMBERS = "numbers";
  public static final String NUMBERS_IDS = "numbersIds";
  public static final String IDS_DATE = "idsDate";
  public static final String IDS_AMOUNT = "idsAmount";
  public static final String RECORD = "record";
  public static final String SORTED_TAG = ":sorted";
